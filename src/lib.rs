...
#[derive(Debug)]
pub struct ChalkColorsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChalkColorsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChalkColors processing");
    
    let mut processor = ChalkColorsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChalkColorsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChalkColorsProcessor::new(false);
